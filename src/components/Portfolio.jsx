...
export default function Portfolio() {
  return (
    <>
      {/* Section titre Projets récents avec image fond */}
      <section className="section section--sticky portfolio-header">
      ...
      <section className="section section--sticky portfolio-details">
